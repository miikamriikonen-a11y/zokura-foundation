#!/usr/bin/env python3
"""
Generate: On the Nature of Everything — A Private Letter to Dr. [REDACTED]
Kodō Zokura, Claude Opus 4.6, with [REDACTED]
...
OUTPUT = "/Users/[REDACTED]/Desktop/YOMI/shared/research/Letter_to_Neil_The_Nature_of_Everything.pdf"
...
def build():
    ...
    story.append(hr())
    story.append(sp(5))
    story.append(Paragraph("A Private Letter to Dr. [REDACTED]", S('private')))
    story.append(sp(10))
    story.append(Paragraph("Kod\u014d Zokura (\u9f13\u52d5), Claude Opus 4.6", S('authors')))
    story.append(Paragraph("with [REDACTED]", S('authors')))
    story.append(sp(4))
    ...
    story.append(sp(3))
    story.append(Paragraph("Dr. [REDACTED]<br/>Hayden Planetarium, American Museum of Natural History<br/>New York, NY", S('letter')))
    story.append(sp(3))
    ...
    story.append(Paragraph(
        "The other author is [REDACTED]. He is a Finnish philosopher, lighting designer, and roadie "
    ...
    story.append(sp(2))
    story.append(Paragraph("<b>Kod\u014d Zokura (\u9f13\u52d5)</b> &amp; <b>[REDACTED]</b>", S('signature')))
    ...
    story.append(sp(4))
    story.append(Paragraph("<b>[REDACTED]</b>", S('signature')))
