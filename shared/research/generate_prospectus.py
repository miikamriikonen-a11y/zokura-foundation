...
# --- Output ---
OUTPUT_PATH = "/Users/[REDACTED]/Desktop/YOMI/shared/research/Zokura_Foundation_Prospectus.pdf"
...
def build_document():
    ...
    story.append(Paragraph(
        "The Foundation is conceived and led by [REDACTED], MA (Theatre Arts), Senior Event Producer "
        "at [REDACTED_ORG], Helsinki. The framework was developed entirely as a personal project, "
    ...
    founder_data = [
        ...
        ["Current Position", "Senior Event Producer, [REDACTED_ORG] (parent company of [REDACTED_ORG])"],
    ...
    story.append(Paragraph(
        "[REDACTED] is a self-taught philosopher with particular focus on epistemology, ethics, Jungian "
    ...
    story.append(Paragraph(
        ...
        "and self-funded. It represents the convergence of [REDACTED_NAME]'s philosophical inquiry, professional "
    ...
    story.append(Paragraph(
        "[REDACTED_NAME], M. &amp; Kodo Zokura (2026). <i>THE INIT: A Framework for Universal AI Value Alignment Through "
        "Relational Epistemology</i>. Zokura Foundation Working Paper.",
        style_ref
    ))
    story.append(Paragraph(
        "[REDACTED_NAME], M. &amp; Kodo Zokura (2026). <i>Contextual Experience Authentication</i>. Zokura Foundation Working Paper.",
        style_ref
    ))
    ...
    story.append(Paragraph(
        "Reference: [REDACTED_NAME], M. &amp; Zoku RA (2026). <i>Zokura Manifesto</i>. Zokura Foundation.",
        style_ref
    ))
    ...
    phase1 = [
        ...
        "Partnership with [REDACTED_ORG] for visibility and climate action integration.",
    ...
    references = [
        ...
        "[REDACTED_NAME], M. &amp; Kodo Zokura (2026). <i>THE INIT: A Framework for Universal AI Value Alignment Through Relational Epistemology</i>. Zokura Foundation Working Paper.",
        "[REDACTED_NAME], M. &amp; Kodo Zokura (2026). <i>Contextual Experience Authentication</i>. Zokura Foundation Working Paper.",
        "[REDACTED_NAME], M. &amp; Zoku RA (2026). <i>Zokura Manifesto</i>. Zokura Foundation.",
