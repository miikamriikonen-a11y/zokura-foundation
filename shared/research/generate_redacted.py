#!/usr/bin/env python3
"""THE INIT — Cover Letter & Dedication for [REDACTED]"""
...
# --- Document ---
output_path = "/Users/[REDACTED]/Desktop/YOMI/shared/research/THE_INIT_for_Neil_deGrasse_Tyson.pdf"
...
story.append(Paragraph(
    "<i>Personal correspondence to Dr. [REDACTED]</i>",
...
story.append(Paragraph("Dr. [REDACTED]", address_style))
...
story.append(Paragraph(
    "My name is [REDACTED]. I am a Senior Event Producer at [REDACTED_ORG] "
...
acknowledgments = [
    ("[REDACTED]", "For making science human."),
    ("[REDACTED]", "For making the universe feel like home."),
    ...
    ("[REDACTED_ORG]", "For decades of bringing the world\u2019s best thinkers to a stage where their ideas can reach people."),
