...
# --- Output ---
OUTPUT = '/Users/miikariikonen/Desktop/YOMI/shared/research/shetlanninlammaskoira_rauman_murteella.pdf'
...
story.append(Paragraph(
    "Jare, nää koira o siis suunniteltu kestämä tuult ja sadhet. "
...
story.append(Spacer(1, 4*mm))
story.append(Paragraph(
    "Jare, jos snää haluut koira jog o hiljane ja välinpitämätö,<br/>"
...
story.append(Paragraph(
    "Jare. Kuuntele ny. Mnää kerron sul migs Sheltti o ylivoimasest "
...
# Lopetus
story.append(Paragraph(
    "Jare — jos snää joskus mietit et pitäskö ottaa Sheltti, "
