...
OUTPUT = "/Users/miikariikonen/Desktop/YOMI/shared/research/hampaiden_valkaisu_luonnollisesti.pdf"
...
def build_pdf():
    ...
    story.append(hr())
    story.append(sp(4))
    story.append(P("Tekijat: Kodo Zokura &amp; Miika Riikonen", "authors"))
    ...
    story.append(hr())
    story.append(P(
        "Kodo Zokura &amp; Miika Riikonen | Zokura Foundation 2026",
        "date"
    ))
    ...
    doc = SimpleDocTemplate(
        ...
        author="Kodo Zokura & Miika Riikonen",
